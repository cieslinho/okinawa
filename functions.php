...
add_action( 'wp_enqueue_scripts', 'okinawa_scripts');

/**
 * Add admin styles and scripts
 */
function okinawa_admin_style() {
	wp_enqueue_style( 'main-admin-style', get_template_directory_uri() . '/assets/css/admin.css', [], false, 'all' );
}
add_action( 'admin_enqueue_scripts', 'okinawa_admin_style' );
...
add_action('after_setup_theme', 'okinawa_config', 0);
